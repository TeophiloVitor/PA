#include <stdio.h>
#include <stdlib.h>
//criamos o void soma com os 4 argmentos, sendo 3 deles vetores criados na int main 
...
// criamos o void preencher para colocar valores dentro dos nossos vetores quando for chamado
