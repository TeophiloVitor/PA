int main() {
  ...
  *p2 = 29.0;
  ...
  p3 = nome;
  printf("%c \n", *p3);
  // como vimos nas video aulas, quando pegamos um ponteiro e o direcionamos para um vetor de caracteres, estamos realmente só pegando o endereço do primeiro elemento do vetor de caractares
  ...
  p3 = p3 +4;
  printf("%c \n", *p3);
  // aqui nós usamos o ponteiro p3 criado na letra e manipulamos ele
  // fazemos aqui uma manipulação com o ponteiro dentro do vetor de caracteres nome, e estamos deslocando 4 casas para a direita
  // agora o nosso ponteiro p3 é o endereço de memoria da variavel nome[4]
